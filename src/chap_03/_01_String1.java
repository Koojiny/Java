...
public class _01_String1 {
    public static void main(String[] args) {
        ...
        System.out.println(s.indexOf("Java")); // 위치 정보 7 (위치는 0부터 시작한다 -> I의 위치 정보는 0)
        System.out.println(s.indexOf("C#")); // 포함되어 있지 않은 경우 위치 정보는 -1로 표현
        System.out.println(s.indexOf("and")); // 처음 일치하는 위치 정보 (12)
        System.out.println(s.lastIndexOf("and")); // 마지막 위치하는 위치 정보 (23)
