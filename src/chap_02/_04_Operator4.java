...
public class _04_Operator4 {
    public static void main(String[] args) {
        ...
        System.out.println(김치찌개 || 계란말이 || 제육볶음); // 셋 중 하나라도 true 이면 결과는 true
        System.out.println(김치찌개 && 계란말이 && 제육볶음); // 셋 모두 true 이면 true
        ...
        // System.out.println(1 < 3 < 5); // 불가능한 코드 (연속적으로 비교하는 것은 불가능하다)
