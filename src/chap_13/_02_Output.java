...
public class _02_Output {
    public static void main(String[] args) {
        ...
        System.out.printf("%.2f%n", Math.PI); // 3.14 (소수점 둘째자리까지 표현)
        System.out.printf("%6.2f%n", Math.PI); // __3.14 (6자리 공간 확보 후 소수점 둘째자리까지 출력)
        ...
        System.out.printf("%6.2s%n", "Java"); // ____Ja (6자리 공간 확보 후 우측 정렬해서 앞 2글자 출력)
        System.out.printf("%-6.2s%n", "Java"); // Ja____ (6자리 공간 확보 후 좌측 정렬해서 앞 2글자 출력)
